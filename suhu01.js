;(function(window, document, undefined){
    ...
    /* settings ------------------------------------------------------------ */
    var ASSET_DIR = 'https://ad.netowl.jp/img/';
    var BANNER_LIST_FOR_ANDROID = [
        {
            img: ASSET_DIR + 'webcrow_xrebirth.gif',
            url: 'https://ad.netowl.jp/rd.php?aid=webcrow_xrebirth_a'
        }
    ];
    var BANNER_LIST_FOR_OTHER = [
        {
            img: ASSET_DIR + 'webcrow_xrebirth.gif',
            url: 'https://ad.netowl.jp/rd.php?aid=webcrow_xrebirth_i'
        }
    ];
    /* --------------------------------------------------------------------- */
